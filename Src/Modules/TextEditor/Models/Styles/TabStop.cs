...
namespace Writersword.Modules.TextEditor.Models.Styles
{
    ...
    public sealed class TabStop
    {
        ...
        /// <summary>
        /// Насколько часто ставятся знаки заполнителя. Единица — обычный шаг, два —
        /// вдвое чаще, половина — вдвое реже.
        ///
        /// Плотность живёт у позиции табуляции, а не у оглавления: дорожку рисует вёрстка
        /// строки, и про оглавление она ничего не знает. Заодно настройка достаётся всякой
        /// другой табуляции с заполнителем — списку действующих лиц, строке с датой справа.
        ///
        /// Ноль и меньше читаются как «обычный шаг»: так рукописи, записанные до появления
        /// поля, открываются без поправок.
        /// </summary>
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public double LeaderDensity { get; set; }
