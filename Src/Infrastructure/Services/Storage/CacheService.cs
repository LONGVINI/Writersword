    ...
    public class CacheService : ICacheService
    {
        ...
        public Dictionary<string, ModuleState>? LoadCache(string projectPath)
        {
            ...
            try
            {
                ...
                Console.WriteLine($"[CacheService] Cache loaded: {cache?.Modules.Count ?? 0} modules");
        ...
        public async Task SaveCacheAsync(string projectPath, Dictionary<string, ModuleState> moduleStates)
        {
            ...
            try
            {
                ...
                Console.WriteLine($"[CacheService] Cache saved: {cachePath} ({moduleStates.Count} modules)");
            }
            catch (Exception ex)
            {
