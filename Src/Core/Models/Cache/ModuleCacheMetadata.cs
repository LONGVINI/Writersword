...
namespace Writersword.Core.Models.Cache
{
    ...
    public class ModuleCacheMetadata
    {
        ...
        /// <summary>
        /// SHA256 хеш файла проекта (.writersword) на момент сохранения кеша.
        /// Используется для быстрой проверки при открытии:
        /// если хеш совпадает — файл не изменялся, диалог восстановления не нужен.
        /// Позволяет избежать загрузки полных данных (400 МБ) до показа диалога.
        /// </summary>
        public string ProjectFileHash { get; set; } = "";
