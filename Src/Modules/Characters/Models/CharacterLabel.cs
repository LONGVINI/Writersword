...
namespace Writersword.Modules.Characters.Models
{
    ...
    public static class CharacterLabelIcons
    {
        ...
        private static readonly Dictionary<string, string> Paths = new()
        {
            ...
            // Звезда своя, а не из общего набора Material. Тамошняя построена
            // не по окружности: её лучи разной длины, левый край уходит дальше
            // правого, и в кружке метки она стояла заметно косо и низко —
            // значок центруется по границам очертания, а у кривой звезды
            // середина границ не совпадает с её осью симметрии.
            //
            // Эта построена явно: пять лучей от центра (12,12), внешний радиус
            // 10, внутренний 4.6 — отношение классической пятиконечной звезды,
            // при котором лучи не превращаются ни в иглы, ни в тупые выступы.
            // Верхний луч смотрит строго вверх.
            [Star] = "M12,2L14.70,8.28L21.51,8.91L16.37,13.42L17.88,20.09L12,16.60L6.12,20.09L7.63,13.42L2.49,8.91L9.30,8.28Z",
